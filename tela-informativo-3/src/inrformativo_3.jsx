...
import './App.css';
import crianca from './assets/crianca_1.png';
      ...
      <Row className="main-content">
        ...
        <Col xs={9} md={15} className="content" style={{paddingLeft: '400px', paddingBottom: '100px', paddingRight: '240px'}}>
          ...
          <div className="banner d-flex justify-content-center align-items-center">
            <img
              src={crianca} // Substitua pelo caminho correto da sua imagem
              alt="Banner"
              className="banner-img"
            />
            <div className="banner-text" style={{top: '-150px'}}>
              <h2>PRODUTOS PARA O CUIDADO BUCAL</h2>
            </div>
          </div>

          {/* Produtos */}
          <div className="products mt-5 d-flex justify-content-center align-items-center">
            <div className="product">
              <img src={pasta} alt="Produto 1" />
            </div>
            <div className="product">
